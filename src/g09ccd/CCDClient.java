...
public class CCDClient extends RoverClientRunnable{

	public CCDClient(int port, InetAddress host)
		...
		try{
		  ...
		  //Send 3 commands to the Server
	        for(int i = 0; i < 4; i++){
	            ...
	            System.out.println("CCD Client: Sending request to Socket Server");
	            ...
	            System.out.println("CCD Client: Message from Server - " + message.toUpperCase());
	            
	            // The server sends us a JSON String here
	            String jsonString = (String) inputFromAnotherObject.readObject();
	            System.out.println("CCDClient: Message from Server - " + jsonString.toUpperCase());
