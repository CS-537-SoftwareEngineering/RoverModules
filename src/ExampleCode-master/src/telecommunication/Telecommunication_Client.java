...
public class Telecommunication_Client extends RoverClientRunnable{
	private static String prefix = "Telecommunication client:";
	private String createdby = "";
	private String message = "";

	public Telecommunication_Client(int port, InetAddress host, String createdBy ,String message)
	...
	public void run() {
		try{
				...
				System.out.println(prefix+" Sending requirement - read xrdDiffraction.json - uplink:: From Chemin");
				...
				if(this.createdby.equalsIgnoreCase(Constants.CHEMIN)){
					...
					outputObjectOutput.writeObject(Constants.TEL_CHANNEL);
