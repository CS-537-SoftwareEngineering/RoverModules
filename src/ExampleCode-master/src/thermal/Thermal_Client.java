...
public class Thermal_Client extends RoverClientRunnable{
	private static String prefix = "Thermal client:";
	private String createdby = "";
	private String message = "";
	
	public Thermal_Client(int port, InetAddress host, String createdBy,String message)
	...
	public void run() {
		try{
				...
				if(this.createdby.equalsIgnoreCase(Constants.CHEMIN)){
					...
					outputObjectOutput.writeObject(message);
