			...
			while (true) {
				...
				if (message.equalsIgnoreCase("exit"))
					...
					System.out.println("");
						...
						.equalsIgnoreCase("HAZCAM_FRONT_CAMERA1__IMAGE")) {
					

					// Using MyWriter class our server writes the changed object
					// into a JSON file
					...
					Thread.sleep(1000);
					System.out
							.println("HCAM_FRONT_CAM1_CAPT (To take a picture from front cam1)");
					Thread.sleep(1000);
					System.out
							.println("HCAM_FRONT_CAM1_OFF (to turn off the front camera1)");
					Thread.sleep(1000);
					System.out.println("<HazCam Server>");
					System.out.println("");
				} else if (message
						.equalsIgnoreCase("HAZCAM_FRONT_CAMERA2__IMAGE")) {
					...
					System.out.println("");
						...
						.equalsIgnoreCase("HAZCAM_REAR_CAMERA1__IMAGE")) {
					...
					Thread.sleep(1000);
					System.out
							.println("HCAM_REAR_CAM1_ON (to turn on the REAR camera1)");
					Thread.sleep(1000);
					System.out
							.println("HCAM_REAR_CAM1_CAPT (To take a picture from REAR cam1)");
					Thread.sleep(1000);
					System.out
							.println("HCAM_REAR_CAM1_OFF (to turn off the REAR camera1)");
					Thread.sleep(1000);
					System.out.println("<HazCam Server>");
					System.out.println("");
				} else if (message
						.equalsIgnoreCase("HAZCAM_REAR_CAMERA2__IMAGE")) {
					...
					Thread.sleep(1000);
					System.out
							.println("HCAM_REAR_CAM2_ON (to turn on the REAR camera2)");
					Thread.sleep(1000);
					System.out
							.println("HCAM_REAR_CAM2_CAPT (To take a picture from REAR cam2)");
					Thread.sleep(1000);
					System.out
							.println("HCAM_REAR_CAM2_OFF (to turn off the REAR camera2)");
					Thread.sleep(1000);
					System.out.println("<HazCam Server>");
					System.out.println("");
