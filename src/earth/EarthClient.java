...
public class EarthClient extends RoverClientRunnable{

	public EarthClient(int port, InetAddress host)
		...
		try{
		  ...
		  //Send 3 commands to the Server
	        for(int i = 0; i < 4; i++){
	            ...
	            System.out.println("Earth: Sending request to Socket Server");
	            ...
	            System.out.println("Earth Client: Message from Server - " + message.toUpperCase());
	            
	            // The server sends us a JSON String here
	            String jsonString = (String) inputFromAnotherObject.readObject();
	            System.out.println("Earth Client: Message from Server - " + jsonString.toUpperCase());
