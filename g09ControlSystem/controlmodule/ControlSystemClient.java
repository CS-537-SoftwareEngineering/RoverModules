...
public class ControlSystemClient extends RoverClientRunnable{
	public String command;
	
	public ControlSystemClient(int port, InetAddress host)
			throws UnknownHostException {
		super(port, host);
		//this.command=command;
	}
	
	public ControlSystemClient(int port, InetAddress host,String command)
			throws UnknownHostException {
		super(port, host);
		this.command=command;
	}
	...
	public void run() {
		try{
		    ...
		    outputToAnotherObject.writeObject(this.command);
