...
public class ModuleTwentyClient extends RoverClientRunnable{

	public ModuleTwentyClient(int port, InetAddress host)
	...
	public void run() {
		try{
	        ...
	        for(int i = 0; i < 4; i++){
	            ...
	            //System.out.println("=================================================");
	            System.out.println("Module 20 Client: Sending request to Socket Server");
	            //System.out.println("=================================================");
	            ...
	            System.out.println("Module 20 Client: Message from Server - " + message.toUpperCase());
	            
	            // The server sends us a JSON String here
	            String jsonString = (String) inputFromAnotherObject.readObject();
	            System.out.println("Module 20 Client: Message from Server - " + jsonString.toUpperCase());
				...
				System.out.println("");
				System.out.println("<Start> Client 20 now has: <Start>");
				System.out.println("===========================================");
