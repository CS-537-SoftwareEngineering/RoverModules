	...
	public void run() {
		...
		try {
			...
			while (true) {
				...
				if (message.equalsIgnoreCase("exit"))
				...
				else if(message.equalsIgnoreCase("MODULE_TWO_DO_SOMETHING-S2")) {
				...
				else if(message.equalsIgnoreCase("MODULE_ONE_GET-S2")) {
					...
					Long oldLong = (Long) thatOtherObject.get("myPower");
					...
					System.out.println("myInteger = " + myPower);
