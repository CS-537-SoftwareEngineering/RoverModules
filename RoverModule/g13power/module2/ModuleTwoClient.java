		...
		try{
	        ...
	        for(int i = 0; i < 4; i++){
	            ...
	            if(i == 3){
	            	...
	            	outputToAnotherObject.writeObject("MODULE_TWO_GET-C2");
	            }
	            else if(i == 1) {
	            	outputToAnotherObject.writeObject("MODULE_ONE_DO_SOMETHING-C2");
	            }
	            else if(i == 0) {
	            	outputToAnotherObject.writeObject("MODULE_PRINT-C2");
	            }
	            ...
	            Long oldLong = (Long) jsonObject.get("myPower");
				
				// Pass the long back into an integer
				Integer myPower = new Integer(oldLong.intValue());
