		...
		try{
		  ...
		  //Send 3 commands to the Server
	        for(int i = 0; i < 4; i++){
	            ...
	            if(i == 3){
	            	outputToAnotherObject.writeObject("POW_CALC");
	            }
	            else if(i == 2){
	            	outputToAnotherObject.writeObject("POW_NOTIFY");
	            }
	            else if(i == 1) {
	            	outputToAnotherObject.writeObject("POW_ON");
	            }
	            else if(i == 0) {
				...
				Long myLong = (Long) jsonObject.get("myPower");
				
				Integer myPower = myLong.intValue();//(Integer) jsonObject.get("myPower");
